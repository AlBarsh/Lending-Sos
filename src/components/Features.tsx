...
const Features = () => {
  return (
    ...
    >
      <div className="text-white tracking-[3px] font-bebas uppercase mb-40px desk:mb-[70px] pl-[10px] w-[320px] desk:translate-x-[70%] ">
        <h3 className="text-[18px] desk:text-[24px]">What’s so special?</h3>
        <h1 className="text-[33px] desk:text-[70px]">features</h1>
      </div>
